...
public class MethodEx003_pulE {
	...
	//6
	public static String myban(char c) { if(c == 'A'){return "노랑조";} else if(c == 'B'){return "주황조";}else{return null;}}//눌 써도됨
...
//			}  로도 가능하다!
	...
	//8
	public static char stdAvg(int d) {
//		if(d >= 90){return 'A';}
//		else if( d>= 80 ){ return 'B';} 
//		else if(d >=70){ return 'C' ;} 
//		else { return 'D' ;}
		//ver2
		return d>90? 'A': d>=80? 'B': d>=70?'C':'D';
		}
	
	
	//return d>90? 'A': (d>=80? 'B': (d>=70?'C':'D'));  이렇게까지 괄호를 안해줘도 됨
	
	
	
	public static void main(String[] args) {
		//public static 이메서드에서내보낼결과값의형태 메서드이름(재료가필요하다면여기){메서드가 할일}
