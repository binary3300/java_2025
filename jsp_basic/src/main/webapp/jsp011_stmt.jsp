...
<!-- 
	...
	mysql이랑 cmd에서 database만들고 table만들던것들을 연동해서 가져옴!!!
 ...
 -->
	...
	<div class="container card my-5">
		...
		try{
			...
			//3. Statement, PreparedStatement... <%@page import="java.sql.*"% > 만 불러오고 다른거는 불러오지않는다!
			stmt = conn.createStatement(); //3-1
			rset = stmt.executeQuery( "select * from milk" ); //3-2 표 불러옴
			while(rset.next()){
